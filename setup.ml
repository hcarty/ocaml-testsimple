...
(* OASIS_START *)
(* DO NOT EDIT (digest: d49dc25b8d84259ffccb4eacae75ad59) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/hcarty/ocaml-testsimple";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/hcarty/ocaml-testsimple.git";
                      src_repo_browser =
                        Some "https://github.com/hcarty/ocaml-testsimple";
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\211X^\193\161\249H\186\167\216\239\184\132\208@\213";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
